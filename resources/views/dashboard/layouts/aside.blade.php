        ...
        @if (Auth::user()->district_id)
            @if (Auth::user()->role->name == 'Gestor de Contenidos')
                ...
                <li class="{{ Str::contains(Route::currentRouteName(), 'activities') ? 'aside-link-active' : null }}">
                    <a href="{{ url('panel-de-administracion/activities') }}"><i
                            class="icon-child"></i>Experiencias</a>
                </li>
                ...
                <li class="{{ Str::contains(Route::currentRouteName(), 'districts') ? 'aside-link-active' : null }}">
                    <a href="{{ url('panel-de-administracion/districts/'.Auth::user()->district_id.'/edit') }}"><i class="icon-map-o"></i>Modificar Municipio</a>
                </li>
            ...
            @elseif(Auth::user()->role->name == "Admin Municipalidad")
                ...
                <li class="{{ Str::contains(Route::currentRouteName(), 'preference') ? 'aside-link-active' : null }}">
                    <a href="{{ url('panel-de-administracion/preferences') }}"><i
                            class="icon-cog"></i>Preferencias</a>
                </li>
