...
<main>
    ...
    <div class="row">
        <div class="add-other only-button">
            <a href="{{ url('dashboard/microservices/create') }}"><button id="open">
        ...
        <div class="flex" id="flex">
            <div class="container-modal">}
                ...
                <div class="modal-body newservice">
                    <form action="{{ url('dashboard/microservices') }}" method="POST" class="modal-body"
                        ...
                        <div>
                            <h4>Enlace de google maps:</h4><input class="@error('map_link') error-input @enderror"
                                type="text" name="map_link" value="" placeholder="">
                        </div>
    ...
    <div class="articles">
        ...
        <section class="article d-flex">
            ...
            <div class="icon">
                <a href="{{ url('dashboard/microservices/' . $service->id . '/edit') }}" class="btn-edit"><i
                        class="icon-edit"></i></a>
            </div>
        </section>
        @endif
