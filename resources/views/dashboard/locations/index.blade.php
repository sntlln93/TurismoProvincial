    ...
    <div id="miModal" class="modal add">
        <div class="flex" id="flex">
            <div class="container-modal">
                ...
                <form action="{{ url('panel-de-administracion/locations') }}" method="POST" class="modal-body" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div><h4>Apertura:</h4><input class="@error('start') error-input @enderror" type="time" name="start" value=""></div>
                    @error('start') <small class="error-message">{{ $message }}</small> @enderror

                    <div><h4>Cierre:</h4><input class="@error('end') error-input @enderror" type="time" name="end" value=""></div>
                    ...
                    <div
                        ><h4>Descripción:</h4>
                        <textarea name="description" class="@error('description') error-input @enderror" rows="6" placeholder="Escribe aquí la descripción"></textarea>
                    </div>
